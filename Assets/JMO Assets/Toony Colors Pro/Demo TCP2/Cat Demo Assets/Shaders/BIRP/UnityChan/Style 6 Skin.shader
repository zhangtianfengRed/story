...
Shader "Toony Colors Pro 2/Examples BIRP/Cat Demo/UnityChan/Style 6 Skijn"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			//Albedo HSV
			float3 albedoHSV = ApplyHSV_3(output.Albedo, __albedoHue, __albedoSaturation, __albedoValue);
			output.Albedo = lerp(output.Albedo, albedoHSV, __albedoHsvMask);
...
/* TCP_DATA u config(ver:"2.9.12";unity:"2022.3.1f1";tmplt:"SG2_Template_Default";features:list["ENABLE_FORWARD_PLUS","UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SHADOW_COLOR_MAIN_DIR","DIFFUSE_TINT","RAMP_MAIN_OTHER","RAMP_SEPARATED","ALBEDO_HSV","ALBEDO_HSV_MASK","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline",RENDER_TYPE="Opaque"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 8bfce6556f76a231f695f0e04d399500 */
